...
lesson_intros = {
        0 : ["Welcome to Lesson 0, Getting started", "Why learn Dvorak? <br> If you've gotten this far, you probably already have a good understanding of what dvorak is and why people switch to it so I won't bore you too much."],
        ...
        6 : ["Welcome to Lesson 6: Putting it all together", "At this point you are a buttery smooth Dvorak user. Try practicing on a site like coderacer.dev. I hope this program helped!"],
        }
